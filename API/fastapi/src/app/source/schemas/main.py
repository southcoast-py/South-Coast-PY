...
from schemas.base_schema import RecipeSearchResults, Recipe, RecipeCreate
from schemas.base_data import RECIPES
...
@api_router.get("/recipes/", status_code=200, response_model=List[Recipe])
